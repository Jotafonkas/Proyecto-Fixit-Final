...
class AdminListSpecialists : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.admin_lista_especialistas)
    ...
    private fun addSpecialistCard(especialista: Map<String, String?>) {
        ...
        val card = inflater.inflate(R.layout.admin_card_lista_usuarios, especialistasContainer, false)
        ...
        card.setOnClickListener {
            val intent = Intent(this, AdminProfileSpecialist::class.java).apply {
