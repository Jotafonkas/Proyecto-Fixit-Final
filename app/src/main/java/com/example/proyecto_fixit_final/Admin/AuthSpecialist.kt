...
class AuthSpecialist : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.auth_specialist)
    ...
    private fun addSpecialistCard(especialista: Map<String, Any?>) {
        ...
        val card = inflater.inflate(R.layout.card_lista_usuarios_autorizacion, especialistasContainer, false)
        ...
        card.setOnClickListener {
            val intent = Intent(this, AuthSpecialistProfile::class.java).apply {
