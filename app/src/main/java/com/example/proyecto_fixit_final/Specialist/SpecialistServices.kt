...
class SpecialistServices : AppCompatActivity() {
    private lateinit var serviciosContainer: LinearLayout
    private lateinit var uid: String

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.especialista_servicios)
    ...
    private fun agregarServicio(nombre: String, descripcion: String, precio: String, imagenUrl: String, categoria: String, estado: String, documentId: String) {
        val servicioView = LayoutInflater.from(this).inflate(R.layout.especialista_card_servicios, serviciosContainer, false)
        ...
        servicioView.setOnClickListener {
            val intent = Intent(this@SpecialistServices, SpecialistDetailService::class.java)
    ...
    fun goDetail(view: View) {
        ...
        val intent = Intent(this, SpecialistDetailService::class.java)
