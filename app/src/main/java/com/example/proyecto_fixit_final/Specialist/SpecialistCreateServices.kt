...
import com.example.proyecto_fixit_final.databinding.EspecialistaCrearServicioBinding
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.storage.FirebaseStorage
import java.util.UUID

class SpecialistCreateServices : AppCompatActivity() {

    private lateinit var binding: EspecialistaCrearServicioBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = EspecialistaCrearServicioBinding.inflate(layoutInflater)
    ...
    private fun setupLoader() {
        ...
        loaderDialog.setContentView(R.layout.app_loader)
