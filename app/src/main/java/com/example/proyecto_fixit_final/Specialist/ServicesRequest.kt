...
import com.example.proyecto_fixit_final.RequestAdapter
import com.google.firebase.firestore.DocumentReference
import com.google.firebase.firestore.DocumentSnapshot
import com.google.firebase.firestore.FirebaseFirestore

class ServicesRequest : AppCompatActivity() {
    private lateinit var recyclerViewSolicitudes: RecyclerView
    private lateinit var solicitudAdapter: RequestAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.solicitudes_especialistas)
        ...
        solicitudAdapter = RequestAdapter(solicitudesList, this::onAcceptClick, this::onRejectClick)
