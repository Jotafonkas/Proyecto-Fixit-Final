...
class SpecialistRegister : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.especialista_registro)
        auth = Firebase.auth
        ...
        val adapter = ArrayAdapter(this, R.layout.app_lista_ciudades, cities)
