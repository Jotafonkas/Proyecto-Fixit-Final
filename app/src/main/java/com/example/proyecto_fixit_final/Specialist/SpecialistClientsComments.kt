...
class SpecialistClientsComments : AppCompatActivity() {
    ...
    private fun displayComments(comments: QuerySnapshot) {
        for (comment in comments) {
            ...
            val commentView = LayoutInflater.from(this).inflate(R.layout.cliente_card_comentario, null)
