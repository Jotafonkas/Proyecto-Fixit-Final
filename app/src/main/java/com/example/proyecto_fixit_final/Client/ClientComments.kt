...
class ClientComments : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.cliente_comentarios)
    ...
    private fun displayComments(comments: QuerySnapshot) {
        ...
        for (document in comments) {
            ...
            val view = LayoutInflater.from(this).inflate(R.layout.cliente_card_comentario, null)
    ...
    fun goNewComment(view: View) {
        val intent = Intent(this, ClientAddComments::class.java)
