...
import com.example.proyecto_fixit_final.Client.ClientComments
import com.example.proyecto_fixit_final.Client.ClientProfileSpecialist
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore
import java.util.UUID

class ClientDetailService : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.cliente_detalle_servicio)
    ...
    fun goToProfileSpecialist(view: View) {
        val intent = Intent(this, ClientProfileSpecialist::class.java)
        intent.putExtra("uid", especialistaId) // Pasa el uid del especialista
        startActivity(intent)
    }

    fun goToComments(view: View) {
        val intent = Intent(this, ClientComments::class.java)
