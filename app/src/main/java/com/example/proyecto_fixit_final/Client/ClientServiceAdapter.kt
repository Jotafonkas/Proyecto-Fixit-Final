...
class ClientServiceAdapter(private val services: MutableList<com.example.proyecto_fixit_final.modelos.Services>) : RecyclerView.Adapter<ClientServiceAdapter.ServiceViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ServiceViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.cliente_card_historial_servicios, parent, false)
