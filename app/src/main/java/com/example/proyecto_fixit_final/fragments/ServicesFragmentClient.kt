...
import com.example.proyecto_fixit_final.Specialist.ViewSpecialistsByCategory
import com.google.firebase.auth.FirebaseAuth

class ServicesFragmentClient : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.frament_services_client, container, false)
    ...
    private fun setupCategory(view: View, linearLayoutId: Int, imageButtonId: Int, textViewId: Int) {
        ...
        val onClickListener = View.OnClickListener {
            ...
            val intent = Intent(activity, ViewSpecialistsByCategory::class.java)
